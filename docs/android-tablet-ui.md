...
These device checks preceded the integrated 0.3.0.0 release. Its complete
CircleCI matrix must be checked separately; the earlier job does not qualify
the unified revision.
