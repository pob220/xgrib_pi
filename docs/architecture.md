...
Provider downloads, NetCDF parsing, UKV regridding, direct-model and XTD
current calculation, and GRIB writing run in the `environmental-grib` helper
process.
...
Offline current is implemented inside this same helper boundary. The plugin UI
